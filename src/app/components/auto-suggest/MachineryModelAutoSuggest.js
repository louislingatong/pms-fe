...
import {machineryModels, machineryModelsAsync} from '../../store/optionSlice';
import PropTypes from 'prop-types';
import classnames from 'classnames';

function MachineryModelAutoSuggest(props) {
  ...
  const loadSuggestions = (value) => {
    if (defaultSuggestions) {
      ...
      dispatch(machineryModelsAsync({keyword: value}));
    }
  };
...
MachineryModelAutoSuggest.propTypes = {
...
export default MachineryModelAutoSuggest;
