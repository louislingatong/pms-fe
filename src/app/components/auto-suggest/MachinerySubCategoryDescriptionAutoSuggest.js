...
import {machinerySubCategoryDescriptions, machinerySubCategoryDescriptionsAsync} from '../../store/optionSlice';
import PropTypes from 'prop-types';
import classnames from 'classnames';

function MachinerySubCategoryDescriptionAutoSuggest(props) {
  const {
    type = 'text',
    name,
    id,
  ...
  const loadSuggestions = (value) => {
    if (defaultSuggestions) {
      ...
      dispatch(machinerySubCategoryDescriptionsAsync({keyword: value}));
    }
  };
...
MachinerySubCategoryDescriptionAutoSuggest.propTypes = {
...
export default MachinerySubCategoryDescriptionAutoSuggest;
